...
lenderAddrSqlStmt = {String lenderTableName ->
...
transactionSqlStmt = { String startDate ->
...
lendingSqlStmt = {String startDate ->
...
borrowingSqlStmt = {String startDate ->
...
userSqlStmt = {String userTableName ->
